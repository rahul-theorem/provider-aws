...
// ResolveReferences of this VPCSecurityGroupEgressRule.
func (mg *VPCSecurityGroupEgressRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
...
// ResolveReferences of this VPCSecurityGroupIngressRule.
func (mg *VPCSecurityGroupIngressRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
